...
public class Simulacion extends javax.swing.JFrame {
    ...
    public Simulacion() {
        ...
        this.setTitle("Simulación de procesos con Shortest Remaining Time");
        
        sistemaOperativo = new SistemaOperativo(this, 700); // Ajusta el valor según tus necesidades
        generadorProcesos = new GeneradorProcesos(this, 700); // Asumiendo 700 MB como la capacidad máxima
    ...
    private void initComponents() {
        ...
        Fondo.setBackground(new java.awt.Color(144, 238, 144));
        Fondo.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        Fondo.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        boton.setText("Empezar simulación");
        boton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonActionPerformed(evt);
            }
        });
        Fondo.add(boton, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 400, -1, -1));

        mensaje.setFont(new java.awt.Font("Sitka Text", 0, 14)); 
        ...
        tiempo.setFont(new java.awt.Font("Sitka Text", 0, 14)); 
        Fondo.add(tiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 290, 30));

        jLabel1.setFont(new java.awt.Font("Sitka Text", 1000, 20)); 
        jLabel1.setText("Simulación");
        Fondo.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, -1, -1));

        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Proceso", "Tiempo asignado", "Memoria asignada", "Estado del proceso"
            }
        ) {
        ...
        Fondo.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 490, 320));
    ...
    public synchronized boolean verificarMemoriaDisponible(int memoriaSolicitada) {
        if(sistemaOperativo.memoriaUtilizada<sistemaOperativo.capacidadMemoria){
            return true;
        }else{
            return false;
        }
