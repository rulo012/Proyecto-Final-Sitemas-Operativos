...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        this.setTitle("Simulación de procesos con Round Robin");

        sistemaOperativo = new SistemaOperativo(this, 1000); 
        generadorProcesos = new GeneradorProcesos(this, 1000);
    ...
    private void initComponents() {
        ...
        Fondo.setBackground(new java.awt.Color(200, 200, 200));
        Fondo.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        Fondo.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        boton.setText("Realizar Simulación");
        boton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonActionPerformed(evt);
            }
        });
        Fondo.add(boton, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 420, 300, -1));
        ...
        jLabel1.setFont(new java.awt.Font("Sitka Text", 0, 25));
        jLabel1.setText("Tabla de simulación");
        Fondo.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 15, 300, -1));
        ...
        Fondo.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 540, 400));
    ...
    public synchronized boolean verificarMemoriaDisponible(int memoriaSolicitada) {
        return sistemaOperativo.memoriaUtilizada<sistemaOperativo.capacidadMemoriaMaxima;
    }
